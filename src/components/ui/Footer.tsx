  ...
  return (
    <footer className="bg-primary z-10 text-light dark:text-dark">
      <div className="mx-auto grid w-full max-w-[1440px] sm:grid-cols-2 lg:grid-cols-12">
        <div className="col-span-full flex min-h-28 flex-col justify-end border-b border-light/25 p-6 sm:p-8 lg:col-span-6 lg:border-r lg:border-b-0 lg:px-10 lg:py-8 dark:border-dark/25">
        ...
        <a
          className="group flex min-h-28 flex-col justify-end border-b border-light/25 p-6 transition-colors hover:bg-light/10 sm:border-r sm:border-b-0 sm:p-8 lg:col-span-3 dark:border-dark/25 dark:hover:bg-dark/10"
        ...
        <a
          ...
          className="group flex min-h-28 flex-col justify-end p-6 transition-colors hover:bg-light/10 sm:p-8 lg:col-span-3 dark:hover:bg-dark/10"
        >
          <span>
            <span className="font-editorial flex items-end justify-between gap-6 text-xl font-medium">
              Get in touch
